...
#include "../inc/SolBasicMILP.h"


SolBasicMILP::SolBasicMILP(unsigned long int V, unsigned long int K, bool MIN_MAX, bool INITIAL_SOLUTION, bool PRIORITIES, bool CLIQUE_CUTS):
            Solver(V, K, MIN_MAX, INITIAL_SOLUTION, PRIORITIES, CLIQUE_CUTS){}

SolBasicMILP::SolBasicMILP(const Solver &s): Solver(s) {}

void SolBasicMILP::solve(Graph* G, std::vector<HoverLocation> &vPotentialHL, std::vector<std::list<int>> &vSPerHL,
